...
```text
帮我安装 game-ui-panels：https://raw.githubusercontent.com/Fable-Forge/game-ui-panels/main/docs/install.md
```
...
- 🐛 Bug 与功能建议：[game-ui-panels Issues](https://github.com/Fable-Forge/game-ui-panels/issues)
