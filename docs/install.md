...
```text
安装 game-ui-panels：https://raw.githubusercontent.com/Fable-Forge/game-ui-panels/main/docs/install.md
```
...
从 `https://github.com/Fable-Forge/game-ui-panels` 安装 `game-ui-panels`，验证目标目录和 `SKILL.md`，并诚实报告哪些 Agent 已可发现。
...
| 运行时 | 目标目录 |
|---|---|
| Codex | `~/.codex/skills/game-ui-panels/` |
| Claude Code | `~/.claude/skills/game-ui-panels/` |
| Agent Skills | `~/.agents/skills/game-ui-panels/` |
